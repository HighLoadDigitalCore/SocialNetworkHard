...
namespace OhAuthToo.ConcreteClients
{
    public class VkontakteClient:IOAuthClient
    {
        ...
        {
            return MakeRequest("/friends.get?fields=first_name,last_name,sex,photo,bdate,photo_big&uid=" + UserId);
        }
        ...
        public string Me()
        {
            ...
            string mearray = MakeRequest("/getProfiles?fields=first_name,last_name,sex,bdate,photo_big,contacts,mobile_phone,has_mobile&uids=" + UserId);
        ...
        public string Mobile
        {
            ...
            {
                var dict = OAuthClientUtils.JsonToDictionary(Me());
                return dict.ContainsKey("mobile_phone") ? dict["mobile_phone"].ToString() : "";
            }
        }
        ...
        public string PhotoUrl
        {
            ...
            {
                var dict = OAuthClientUtils.JsonToDictionary(Me());
                if (dict.ContainsKey("photo_big"))
                {
                    return dict["photo_big"].ToString();
                }
                return string.Empty;
            }
        }
        ...
        public Gender Gender
        {
            ...
            { 
                ...
                if (dict["sex"]!=null)
                {
                    return (int)dict["sex"] == 2 ? Gender.Male : Gender.Female;
                }
                return Gender.Any;
            }
        }
